...
package es.upv.grycap.opengateway.example.test;
...
import static es.upv.grycap.opengateway.example.test.mockserver.ProductCatalogService.getProducts;
import static es.upv.grycap.opengateway.example.test.mockserver.ShippingService.getShipping;
...
import es.upv.grycap.opengateway.example.AppDaemon;
import es.upv.grycap.opengateway.example.test.mockserver.Product;
import es.upv.grycap.opengateway.example.test.mockserver.Shipping;
